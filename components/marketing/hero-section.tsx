    ...
    >
      <div className="relative z-10 marketing-container flex min-h-[100svh] flex-col justify-center gap-12 pb-20 pt-28 lg:flex-row lg:items-center lg:gap-8 lg:pb-28 lg:pt-24">
        <div className="w-full shrink-0 lg:w-[55%] lg:max-w-none">
          <span className="marketing-badge">UK analytical testing service</span>
          ...
          <p className="hero-sub mt-6">
            HPLC and LC-MS reporting with QR-linked certificate registry lookup.
            Structured records for research traceability and batch documentation.
          </p>
          <ResearchUseOnlyNotice className="mt-6 max-w-xl" />
          ...
          <div className="trust-chips mt-8">
            <span>✓ UK sample coordination</span>
            <span>✓ EU partner labs (HPLC)</span>
